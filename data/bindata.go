...
func generateTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "generate.txt", size: 12883, mode: os.FileMode(420), modTime: time.Unix(1582911461, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
